...
const add_order_list = (order_list) => {
	...
	const pay_box = document.querySelector('article.order_list')
	...
	pay_box.innerHTML += pay_button_html
...
document.addEventListener("DOMContentLoaded", () => {
	...
	// 선언되고 OS 에게 알려진 코드이다
	// div.button_box가 아직 만들어지지 않은 상태에서 선언된 
	// event 핸들러는 os 가 무시해버린다
	//if(pay_box) {
	...
	// 실제 tag가 생성된 후에 event를 버블링 할 수 있도록 
	// 설정하는 방법
